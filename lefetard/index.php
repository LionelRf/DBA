...
<head>
<meta charset="UTF-8"/>
<title>The Best of DBA</title>
<meta name="viewport" content="width=device-width,initial-scale=1"/>
<meta name="description" content="Maîtriser les bases de données, maximiser les performances."/>
...
<a href="index.php#content" class="skip-link" accesskey="s">Aller au contenu</a>
...
<form class="form-contact" action="index.php" method="post" name="form-contact" id="form-contact" enctype="multipart/form-data">
<p class="form-name">
<span class="row-fluid">
<span class="span6">
<span class="form-field">
<input type="text" name="contact_name" id="contact_name" value="" placeholder="Entrer votre nom" required="required"/>
</span>
</span>
</span>
</p>
...
<span class="span6">
<span class="form-field">
<input type="email" name="contact_email" id="contact_email" value="" placeholder="Entrer votre adresse email" required="required"/>
</span>
</span>
</span>
</p>
...
<span class="span6">
<span class="form-field">
<input type="url" name="contact_url" id="contact_url" value="" placeholder="Entrer votre URL"/>
</span>
</span>
<span class="span6">
...
<span class="span12">
<span class="form-field">
<textarea rows="6" cols="120" name="contact_message" id="contact_message" placeholder="Entrer votre message" required="required"></textarea>
</span>
</span>
</span>
</p>
...
<span class="row-fluid">
<span class="span12">
<label for="contact_copy" class="label-checkbox">
<input type="checkbox" class="checkbox" name="contact_copy" id="contact_copy" value="1"/>
<span class="label-text">M'envoyer une copie du message</span>
</label>
</span>
</span>
</p>
...
<span class="span12">
<span class="form-button">
<input type="hidden" name="signature" id="signature" value="561b6855a4bbeb16f4b30003bffd3076c2cdb791"/>
<input type="hidden" name="evnt" id="evnt" value="sendcontact"/>
<input type="submit" name="contact-submit" id="contact-submit" class="button" value="Envoyer"/>
</span>
</span>
</span>
</p>
